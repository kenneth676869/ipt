<nav class="navbar navbar-expand-lg navbar-light shadow" style="background-color:black;">
    ...
    <h2 class="p-2 text-white" style="font-size:23px; font-weight:400;"><span style="margin-right: 30px" class=" fa-solid fa-dragon"></span>Play.com</h2>
        ...
        <ul class="navbar-nav d-flex align-items-end justify-content-end">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ 'recent-post' == request()->path() ? 'active' : '' }}"
                    href="{{ '/recent-post' }}"><span class="fa fa-history text-white"></span>Recent Games</a>
            </li>
            ...
            @role('admin')
                ...
                <div class="dropdown" >
                    <a  class=" btn dropdown-toggle text-warning  bg-opacity-75" style="background-color: violet" type="button" id="dropdownMenuButton" data-toggle="dropdown"
                        aria-haspopup="true" aria-expanded="false"><span class="fa-solid fa-alien-8bit"></span>
                        Admin
                    </a>
