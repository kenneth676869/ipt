...
@section('content')
    <div class="container mt-3" >
        <h1 class="text-center" style="font-weight: 400; color:blue; font-size: 30px;">Dashboard</h1>
                        ...
                        <a href="/recent-post" id="dash-link">
                            <div class="card-body rounded " style="background-color: red;">
                                <div class="row">
                                    ...
                                    <div class="col mt-4">
                                        <span class="text-white float-right" id="text">Recent Game</span><br>
                        ...
                        <a href="/my-post" id="dash-link">
                            <div class="card-body rounded" style="background-color: red;">
                                <div class="row">
                                    ...
                                    <div class="col mt-4">
                                        <span class="text-white float-right" id="text">&nbsp Your Games</span><br>
                        ...
                        <a href="/log" id="dash-link">
                            <div class="card-body rounded" style="background-color: red;">
                                <div class="row">
                                    ...
                                    <div class="col mt-4">
                                        <span class="text-white float-right" id="text"><br> Total Logs</span><br>
